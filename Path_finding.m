...
chosen_reference_path = refInterp_PRM; %Change value to either refInterp_RRT, refInterp_BiRRT, refInterp_RRTstar, refInterp_PRM
chosen_actual_path = actualPath_PRM; %Change value to either actualPath_RRT, actualPath_BiRRT, actualPath_RRTstar, actualPath_PRM
...
xlabel('X'); ylabel('Y'); zlabel('Z');
view(3);
title(sprintf('Nearest-Neighbour Deviations RRT'));
...
xlabel('X'); ylabel('Y'); zlabel('Z');
view(3);
title(sprintf('Nearest-Neighbour Deviations BiRRT'));
...
xlabel('X'); ylabel('Y'); zlabel('Z');
view(3);
title(sprintf('Nearest-Neighbour Deviations PRM'));
